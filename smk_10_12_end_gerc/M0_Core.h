...
#define NVIC_INT_SET_EN(n, IRQn)        NVIC->ISER[n] = (1 <<((u32)(IRQn)))
#define NVIC_INT_CLR_EN(n, IRQn)        NVIC->ISER[n] = (1 <<((u32)(IRQn))) //?
...
#define RCC_CFGR_SW_HSI48       0x3                             /*!< HSI48 selected as system clock */
...
#define RCC_CFGR_SWS_HSE        0x1                             /*!< HSE oscillator used as system clock */
#define RCC_CFGR_SWS_PLL        0x2                             /*!< PLL used as system clock */
#define RCC_CFGR_SWS_HSI48      0x3                             /*!< HSI48 oscillator used as system clock */
...
volatile u32 RSVD1[25];         //Reserved
volatile u32 SYSCFG_ITLINE[31];  //SYSCFG interrupt line 0 status register (SYSCFG_ITLINE0)
...
struct
  {
    ...
    u1 PM         : 1;  //AM/PM notation 0: AM or 24-hour format 1: PM
    u1 RSVD2      : 9;  //Reserved
  }volatile RTC_TR;   //RTC time register (RTC_TR)
struct
  {
    ...
    u1 WDU        : 3;  //Reserved
    u1 YU         : 4;  //Hour units in BCD format
    u1 YT         : 4;  //Hour tens in BCD format
    u1 RSVD2      : 8;  //Reserved
  }volatile RTC_DR;   //RTC date register (RTC_DR)
struct
  {
    ...
    u1 RSVD1            : 1;  //Reserved
    u1 WUTE             : 1;  //Wakeup timer enable 0:  disabled 1:  enabled
    ...
    u1 RSVD3            : 8;  //Reserved
  }volatile RTC_CR;  //RTC control register (RTC_CR)
struct
{
  ...
  u1 RSVD2              : 15; //Reserved
}volatile RTC_ISR;  //RTC initialization and status register (RTC_ISR)
struct
{
  ...
  u1 RSVD1              : 9;  //Reserved
}volatile RTC_PRER; //RTC prescaler register (RTC_PRER)
struct
{
  u1 WUT                : 16; //Wakeup auto-reload value bits
  u1 RSVD0              : 1;  //Reserved
}volatile RTC_WUTR;    //RTC wakeup timer register (RTC_WUTR)
volatile u32 RSVD0;   //Reserved
struct
{
  u1 SU                 : 4;  //Second units in BCD format
...
}volatile RTC_ALRMAR;   //RTC alarm A register (RTC_ALRMAR)
volatile u32 RSVD1;   //Reserved
struct
{
  u1 KEY                : 8;  //Write protection key
  u1 RSVD0              : 24; //Reserved
}volatile RTC_WPR;      //RTC write protection register (RTC_WPR)
struct
{
  u1 SS                 : 16; //Sub second value
  u1 RSVD0              : 16; //Reserved
}volatile RTC_SSR;      //RTC sub second register (RTC_SSR)
struct
{
  u1 SUBFS              : 15; //Subtract a fraction of a second
  u1 RSVD0              : 16; //Reserved
  u1 ADD1S              : 1;  //Add one second
}volatile RTC_SHIFTR;   //RTC shift control register (RTC_SHIFTR)
struct
{
  u1 SU                 : 4;  //Second units in BCD format
  u1 ST                 : 3;  //Second tens in BCD format
  ...
  u1 PM                 : 1;  //AM/PM notation 0: AM or 24-hour format 1: PM
  u1 RSVD2              : 9;  //Reserved
}volatile RTC_TSTR;     //RTC timestamp time register (RTC_TSTR)
struct
{
  u1 DU                 : 4;  //Date units in BCD format
  u1 DT                 : 2;  //Date tens in BCD format
  ...
  u1 RSVD1              : 16; //Reserved
}volatile RTC_TSDR;     //RTC timestamp date register (RTC_TSDR)
struct
{
  u1 SS                 : 16; //Sub second value
  u1 RSVD1              : 16; //Reserved
}volatile RTC_TSSSR;    //RTC time-stamp sub second register (RTC_TSSSR)
struct
{
...
struct
{
  ...
  u1 TAMPPRCH           : 2;  //RTC_TAMPx precharge duration
  ...
  u1 RSVD1              : 8;  //Reserved
}volatile RTC_TAFCR;    //RTC tamper and alternate function configuration register (RTC_TAFCR)
struct
{
  ...
  u1 RSVD1              : 4;  //Reserved
}volatile RTC_ALRMASSR;       //RTC alarm A sub second register (RTC_ALRMASSR)
volatile u32 RSVD2[2];   //Reserved
struct
{
  u1 WKP_CAUSE          : 2;
  u1 TAMP               : 2;
  ...
  u1 RSV                : 10;
  u1 CNT                : 16;
}volatile RTC_BKPxR_0;    //RTC backup registers (RTC_BKPxR)
struct
{
  u1 STATE              : 8;
  u1 DATA1              : 8;
  u1 RSV                : 16;
}volatile RTC_BKPxR_1;    //RTC backup registers (RTC_BKPxR)
struct
{
  u1 WKP_CAUSE          : 2;
  u1 TAMP               : 2;
  ...
  u1 RSV                : 10;
  u1 BKP                : 16;
}volatile RTC_BKPxR_2;    //RTC backup registers (RTC_BKPxR)
struct
{
  u1 WKP_CAUSE          : 2;
  u1 TAMP               : 2;
  ...
  u1 RSV                : 10;
  u1 BKP                : 16;
}volatile RTC_BKPxR_3;    //RTC backup registers (RTC_BKPxR)
}RTC_Type;
...
struct
  {
    ...
    u1 DBP              : 1;  //Disable RTC domain write protection
    u1 RSVD0            : 23; //Reserved
  }volatile PWR_CR;     //Power control register (PWR_CR)
struct
  {
    ...
    u1 RSVD0            : 4;  //Reserved
    u1 EWUPx            : 8;  //Enable WKUPx pin
    u1 RSVD2            : 16; //Reserved
  }volatile PWR_CSR;    //Power control/status register (PWR_CSR)
}PWR_Type;
...
typedef struct
{
  struct
  {
    u1 DEV_ID                   : 12; //Device identifier
    u1 RSVD0                    : 4;  //Reserved
    u1 REV_ID                   : 16; //Revision identifier
  }volatile DBGMCU_IDCODE;      //MCU device ID code
  struct
  {
    u1 RSVD0                    : 1;  //Reserved
    u1 DBG_STOP                 : 1;  //Debug Stop mode
    u1 DBG_STANDBY              : 1;  //Debug Standby mode
    u1 RSVD1                    : 29; //Reserved
  }volatile DBGMCU_CR;          //Debug MCU configuration register (DBGMCU_CR)
  struct
  {
    u1 DBG_TIM2_STOP            : 1;  //TIM2 counter stopped when core is halted
    u1 DBG_TIM3_STOP            : 1;  //TIM3 counter stopped when core is halted
    u1 RSVD0                    : 2;  //Reserved
    u1 DBG_TIM6_STOP            : 1;  //TIM6 counter stopped when core is halted
    u1 DBG_TIM7_STOP            : 1;  //TIM7 counter stopped when core is halted
    u1 RSVD1                    : 2;  //Reserved
    u1 DBG_TIM14_STOP           : 1;  //TIM14 counter stopped when core is halted
    u1 RSVD2                    : 1;  //Reserved
    u1 DBG_RTC_STOP             : 1;  //Debug RTC stopped when core is halted
    u1 DBG_WWDG_STOP            : 1;  //Debug window watchdog stopped when core is halted
    u1 DBG_IWDG_STOP            : 1;  //Debug independent watchdog stopped when core is halted
    u1 RSVD3                    : 8;  //Reserved
    u1 DBG_I2C1_SMBUS_TIMEOUT   : 1;  //SMBUS timeout mode stopped when core is halted
    u1 RSVD4                    : 3;  //Reserved
    u1 DBG_CAN_STOP             : 1;  //CAN stopped when core is halted
    u1 RSVD5                    : 6;  //Reserved
  }volatile DBGMCU_APB1_FZ;     //Debug MCU APB1 freeze register (DBGMCU_APB1_FZ)
  struct
  {
    u1 RSVD0                    : 11; //Reserved
    u1 DBG_TIM1_STOP            : 1;  //TIM1 counter stopped when core is halted
    u1 RSVD1                    : 4;  //Reserved
    u1 DBG_TIM15_STOP           : 1;  //TIM15 counter stopped when core is halted
    u1 DBG_TIM16_STOP           : 1;  //TIM16 counter stopped when core is halted
    u1 DBG_TIM17_STOP           : 1;  //TIM17 counter stopped when core is halted
    u1 RSVD2                    : 13; //Reserved
  }volatile DBGMCU_APB2_FZ;     //Debug MCU APB2 freeze register (DBGMCU_APB2_FZ)

}DBG_Type;
#define DBG ((DBG_Type*) DBGMCU_BASE)
/******************************************* IWDG **************************************************/
typedef struct
{
struct
  {
    u1 KEY              : 16; //Key value (write only, read 0x0000)
    u1 RSVD0            : 16; //Reserved
  }volatile IWDG_KR;     //Key register (IWDG_KR)
struct
  {
    u1 PR               : 3;  //Prescaler divider
    u1 RSVD0            : 29; //Reserved
  }volatile IWDG_PR;    //Prescaler register (IWDG_PR)
  struct
  {
    u1 RL                 : 12; //Watchdog counter reload value
    u1 RSVD0              : 20; //Reserved
  }volatile IWDG_RLR;     //Reload register (IWDG_RLR)
  struct
  {
    ...
    u1 RSVD0              : 29; //Reserved
  }volatile IWDG_SR;     //Status register (IWDG_SR)
  struct
  {
    u1 WIN                : 12; //Watchdog counter window value
    u1 RSVD0              : 20; //Reserved
  }volatile IWDG_WINR;     //Window register (IWDG_WINR)
}IWDG_Type;
